...
#define LEFT_HALL_U_PIN GPIO_PIN_7//GPIO_PIN_5
#define LEFT_HALL_V_PIN GPIO_PIN_6//GPIO_PIN_6
#define LEFT_HALL_W_PIN GPIO_PIN_5//GPIO_PIN_7

#define LEFT_HALL_U_PORT GPIOB
#define LEFT_HALL_V_PORT GPIOB
#define LEFT_HALL_W_PORT GPIOB

#define RIGHT_HALL_U_PIN GPIO_PIN_12//GPIO_PIN_10
#define RIGHT_HALL_V_PIN GPIO_PIN_11//GPIO_PIN_11
#define RIGHT_HALL_W_PIN GPIO_PIN_10//GPIO_PIN_12
